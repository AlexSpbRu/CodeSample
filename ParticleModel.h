...
protected :
	...
	template <  typename Head,  typename...  Args, 
		class = typename std::conditional< std::is_same<std::function<float()>, Head>::value, void, 
									typename std::enable_if<std::is_same<decltype(void(&Head::operator())), float>::value>::type > >
